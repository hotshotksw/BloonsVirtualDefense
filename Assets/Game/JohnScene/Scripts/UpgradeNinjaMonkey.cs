...
public class UpgradeNinjaMonkey : MonoBehaviour
{
    [SerializeField] NinjaMonkey monkey;
    ...
    public void OnUpgradePress()
    {
        if (upgradeCount < 5)
        {
            ...
            if (player.Bananas >= upgradePrice)
            {
                ...
                {
                    case 0:
                        monkey.sharperShurikens = true;
                        break;
                    case 1:
                        monkey.ninjaDiscipline = true;
                        break;
                    case 3:
                        monkey.doubleShot = true;
                        break;
                    case 4:
                        monkey.grandmaster = true;
                        break;
                }
                upgradeCount++;
